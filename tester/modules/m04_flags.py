...
def run(ev):
    ...
    bench_ok = ret == 0 and out.strip() != "" and bench_has_expected_fields(err)
    ...
    disorder_ok = ret == 0 and out.strip() == "" and bench_disorder_is(err, "0.00")
    ...
    reverse_bench_ok = ret == 0 and out.strip() != "" and bench_disorder_is(err, "100.00")
